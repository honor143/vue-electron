<template>
  <div ref="warnWrapper" id="warn-wrapper">
    <Row :gutter="5">
      ...
      <Modal width="1000" title="股票涨跌记录表" v-model="modal8" :mask-closable="true" :styles="{top:'50px'}" footer-hide @on-visible-change="modelChange">
...
export default {
  ...
  methods: {
    ...
    resizeHandle () {
      this.$nextTick(() => {
        this.tableHeight = this.$refs.warnWrapper.clientHeight - 40;
...
#warn-wrapper >>> .show-content {
  height: calc(100% - 27px);
}
.warn-table {
  height: 740px !important;
}
.warn-table >>> .ivu-table-body,.warn-table >>> .ivu-table-tip{
