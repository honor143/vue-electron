      ...
      return yield new Promise((resolve, reject) => {
        server.on("request", (request, response) => {
          ...
          if (requestUrl === "/") {
            ...
            const debug = _this._logger.debug;
            ...
            _this.doProxyUpdateFile(response, zipFileInfo.url.href, downloadUpdateOptions.requestHeaders, zipFileInfo.info.sha512, downloadUpdateOptions.cancellationToken, error => {
              errorOccurred = true;
