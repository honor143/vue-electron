  ...
  switch (provider) {
    case "github":
      ...
      if (token == null) {
        ...
        return new (_PrivateGitHubProvider().PrivateGitHubProvider)(githubOptions, updater, token, httpExecutor);
      }
    ...
    case "generic":
      const options = data;
      return new (_GenericProvider().GenericProvider)(options, updater, options.useMultipleRangeRequest !== false && isUrlProbablySupportMultiRangeRequests(options.url));
