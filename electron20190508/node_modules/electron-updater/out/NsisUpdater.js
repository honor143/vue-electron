  ...
  differentialDownloadInstaller(fileInfo, downloadUpdateOptions, installerPath, requestHeaders, provider) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      try {
        ...
        const oldBlockMapUrl = (0, _main().newUrlFromBase)(`${fileInfo.url.pathname.replace(downloadUpdateOptions.updateInfo.version, _this3.currentVersion.version)}.blockmap`, fileInfo.url);
